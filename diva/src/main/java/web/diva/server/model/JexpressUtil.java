...
public class JexpressUtil {
    ...
    public web.diva.shared.model.core.model.dataset.Dataset initWebDataset(Dataset jexpressDataset, int datasetId) {
    ...
    public List<String> initGroupGeneList(web.diva.shared.model.core.model.dataset.Dataset dataset, int[] members) {
    ...
    public Map<Integer, Number[]> initIndexMembers(web.diva.shared.model.core.model.dataset.Dataset dataset) {
